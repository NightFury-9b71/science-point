...
api.interceptors.response.use(
  ...
  (error) => {
    ...
    if (error.response?.status === 401) {
      // Token is invalid or expired - let AuthContext handle this
      Logger.warn('Authentication failed - 401 response received')
...
export const adminAPI = {
  ...
  updateMyProfile: (adminId, profileData) => api.put(`/admin/${adminId}/profile`, profileData),
  changeMyPassword: (adminId, passwordData) => api.patch(`/admin/${adminId}/password`, passwordData)
}
...
export const teacherAPI = {
  ...
  // Profile Updates
  updateMyProfile: (teacherId, profileData) => api.put(`/teacher/${teacherId}/profile`, profileData),
  changeMyPassword: (teacherId, passwordData) => api.patch(`/teacher/${teacherId}/password`, passwordData),
...
export const studentAPI = {
  ...
  // Profile Updates
  updateMyProfile: (studentId, profileData) => api.put(`/student/${studentId}/profile`, profileData),
  changeMyPassword: (studentId, passwordData) => api.patch(`/student/${studentId}/password`, passwordData),
