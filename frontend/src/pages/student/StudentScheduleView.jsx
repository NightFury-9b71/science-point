...
import { Calendar, Clock, BookOpen, Grid, List } from 'lucide-react'

import Card from '../../components/Card'
import Button from '../../components/Button'
import { useStudentSchedule } from '../../services/queries'

const StudentScheduleView = ({ studentId }) => {
  ...
  const { data: schedule = [], isLoading } = useStudentSchedule(studentId, viewMode === 'daily' ? selectedDay : null)
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-3 sm:space-y-0">
        <div className="flex items-center space-x-3">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">My Class Schedule</h1>
        </div>
        ...
        <Card className="p-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600">
              {schedule.length > 0 ? new Set(schedule.map(s => s.teacher_id)).size : 0}
            </div>
