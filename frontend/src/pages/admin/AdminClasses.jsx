...
import { useClasses, useTeachers, useCreateClass, useUpdateClass } from '../../services/queries'
...
const AdminClasses = () => {
  ...
  const [form, setForm] = useState({
    name: '', grade: 6, section: '', academic_year: '', capacity: 30, class_teacher_id: null
  })
  ...
  const handleUpdateClass = async (e) => {
    ...
    try {
      const updateData = {
        ...
        class_teacher_id: editForm.class_teacher_id ? parseInt(editForm.class_teacher_id) : null
      }
          ...
          <Card key={cls.id} className="p-4">
            <div className="space-y-2">
              ...
              <div className="text-xs text-gray-500 space-y-1">
                ...
                <p>Teacher: {cls.class_teacher_id ? teachers?.find(t => t.id === cls.class_teacher_id)?.user?.full_name || `Teacher ${cls.class_teacher_id}` : 'No teacher assigned'}</p>
              </div>
            </div>
          </Card>
        ))) : (
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Select
            ...
            onChange={(e) => setForm({ ...form, class_teacher_id: e.target.value ? parseInt(e.target.value) : null })}
            options={[
        ...
        {editForm && (
          <form onSubmit={handleUpdateClass} className="space-y-4">
            ...
            <Select
              ...
              onChange={(e) => setEditForm({ ...editForm, class_teacher_id: e.target.value ? parseInt(e.target.value) : null })}
              options={[
                { value: '', label: 'No teacher assigned' },
                ...(teachers?.map(teacher => ({ 
                  value: teacher.id, 
