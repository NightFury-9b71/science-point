import { User, Phone, Calendar, Shield, Camera, X, Check, Upload, Users, GraduationCap, BookOpen, FileText, Settings, Edit3, Save, Lock, Eye, EyeOff } from 'lucide-react'
import Card from '../../components/Card'
import Button from '../../components/Button'
import { useAuth } from '../../contexts/AuthContext'
import { useAdminProfile, useAdminUploadPhoto, useAdminDeletePhoto, useChangeAdminPassword, useUpdateAdminProfile } from '../../services/queries'
...
function AdminProfile() {
  ...
  const handleSaveProfile = async () => {
    try {
      ...
      // Update profile via mutation hook
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="shadow-md hover:shadow-lg transition-shadow duration-200">
          <Card.Header className="border-b border-gray-100 pb-4">
            <Card.Title className="text-lg font-semibold flex items-center justify-between">
        ...
        <Card className="shadow-md hover:shadow-lg transition-shadow duration-200">
          ...
          <Card.Content className="pt-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <ActionButton icon={Users} label="Manage Students" color="blue" onClick={() => navigate('/admin-dashboard/students')} />
              <ActionButton icon={GraduationCap} label="Manage Teachers" color="green" onClick={() => navigate('/admin-dashboard/teachers')} />
              <ActionButton icon={BookOpen} label="Manage Subjects" color="purple" onClick={() => navigate('/admin-dashboard/subjects')} />
              <ActionButton icon={FileText} label="View Reports" color="orange" onClick={() => navigate('/admin-dashboard/performance')} />
            </div>
          </Card.Content>
        </Card>
      </div>
